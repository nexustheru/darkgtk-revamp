...
// WickedX - 081014 - moved to globstruct.h
...
bool CObjectManager::PreSceneSettings ( void )
{
	...
	// WickedX - 081014 r114 - moved to CGfxC.cpp Setup()
	/*
	...
	for ( int texturestage=0; texturestage<8; texturestage++) {
		// WickedX - 081014 - will now use iAnisotropyLevel from globstruct.h
		//m_pD3D->SetSamplerState ( texturestage, D3DSAMP_MAXANISOTROPY, g_iAnisotropyLevel );
		if ( g_pGlob->dwAnisotropyLevel>g_pGlob->dwMaxAnisotropyLevel )
			g_pGlob->dwAnisotropyLevel = g_pGlob->dwMaxAnisotropyLevel;

		m_pD3D->SetSamplerState ( texturestage, D3DSAMP_MAXANISOTROPY, g_pGlob->dwAnisotropyLevel );
	}
