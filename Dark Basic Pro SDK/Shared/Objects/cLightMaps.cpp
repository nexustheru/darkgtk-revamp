...
bool cLightMaps::UpdateObject ( sMesh* pMesh )
{
	...
	if ( bRedoObjectWithNewLM==false )
	{
		...
		pMesh->pTextures [ 0 ].dwMagState		= D3DTEXF_LINEAR;//2x2 sample
		pMesh->pTextures [ 0 ].dwMinState		= D3DTEXF_LINEAR;
//		pMesh->pTextures [ 0 ].dwMagState		= D3DTEXF_NONE;//test-nofilter
//		pMesh->pTextures [ 0 ].dwMinState		= D3DTEXF_NONE;
		pMesh->pTextures [ 0 ].dwMipState		= D3DTEXF_NONE;
