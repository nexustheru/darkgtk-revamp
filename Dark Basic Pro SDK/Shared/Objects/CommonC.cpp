...
#include "CommonC.h"
	...
	// WickedX - 240814 r114 - Added include for memblock - object customdata
...
DBPRO_GLOBAL eSortOrder                     g_eGlobalSortOrder              = E_SORT_BY_TEXTURE;
...
DARKSDK_DLL void PassCoreData ( LPVOID pGlobPtr )
{
	...
	g_pCreateDeleteStringFunction = g_pGlob->CreateDeleteString;
		...
		// WickedX - 240814 r114 - Added function pointers for memblock - object customdata
		g_Memblock_GetMemblockExist = dbMemblockExist;
		g_Memblock_GetMemblockSize = dbGetMemblockSize;
...
DARKSDK_DLL bool DeleteObject ( int iID )
{
	...
	else
	{
		...
		SAFE_DELETE ( pObject->pInstanceMeshVisible );
	}
