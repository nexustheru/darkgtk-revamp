...
void CreateCollisionChecklist ( void )
{
	...
	g_pGlob->checklist [ 8 ].fvaluea = MegaCollisionFeedback.vecNormal.x;
	g_pGlob->checklist [ 8 ].fvalueb = MegaCollisionFeedback.vecNormal.y;
	g_pGlob->checklist [ 8 ].fvaluec = MegaCollisionFeedback.vecNormal.z;
}
