...
DARKSDK void ConstructorD3D ( HINSTANCE hSetup, HINSTANCE hImage )
{
	...
	// link up image functions
		...
		// WickedX - 210914 r114 - Added missing function pointer for DarkGDK - Used by dbTextureBackdrop()
...
// WickedX - 271014 r114 - Get Current Camera Range Near
DARKSDK float GetNear( void )
{
	float res;
	tagCameraData* pCamera;

	pCamera = (tagCameraData*) GetInternalData(g_pGlob->dwCurrentSetCameraID);
	res = pCamera->fZNear;
	return res;
}

// WickedX - 271014 r114 - Get Current Camera Range Far
DARKSDK float GetFar( void )
{
	float res;
	tagCameraData* pCamera;
...
// WickedX - 271014 r114 - Get Current Camera FOV
DARKSDK float GetFOV ( void )
{
	float res;
	tagCameraData* pCamera;
...
// WickedX - 261014 r114 - Get Current Camera Aspect
DARKSDK float GetAspect( void )
{
	float res;
	tagCameraData* pCamera;
...
// WickedX - 240814 r114 - Added internal function SetPosition(int iID, D3DXVECTOR3 pos)
DARKSDK void SetPosition ( int iID, D3DXVECTOR3 pos )
{
	if ( iID < 0 || iID > MAXIMUMVALUE )
	{
		RunTimeError ( RUNTIMEERROR_CAMERANUMBERILLEGAL );
...
// WickedX - 271014 r114 - Get Camera Range Near
DARKSDK float GetNear( int iID )
{
	float res;
	tagCameraData* pCamera;

	pCamera = (tagCameraData*) GetInternalData(iID);
	res = pCamera->fZNear;
	return res;
}

// WickedX - 271014 r114 - Get Camera Range Far
DARKSDK float GetFar( int iID )
{
	float res;
	tagCameraData* pCamera;
...
// WickedX - 271014 r114 - Get Camera FOV
DARKSDK float GetFOV ( int iID )
{
	float res;
	tagCameraData* pCamera;
...
// WickedX - 261014 r114 - Get Camera Aspect
DARKSDK float GetAspect ( int iID )
{
	float res;
	tagCameraData* pCamera;
...
// WickedX - 271014 r114 - function wrapper for dbCameraNear()
float dbCameraNear( void )
{
	return GetNear();
}

// WickedX - 271014 r114 - function wrapper for dbCameraFar()
float dbCameraFar( void )
{
	return GetFar();
}
...
// WickedX - 271014 r114 - function wrapper for dbCameraFOV()
float dbCameraFOV( void )
{
	return GetFOV();
}
...
// WickedX - 261014 r114 - function wrapper for dbCameraAspect(void)
float dbCameraAspect ( void )
{
	return GetAspect();
}
...
// WickedX - 240814 r114 - Added function wrapper for dbSetPosition(int iID, D3DXVECTOR3 pos)
void dbPositionCamera ( int iID, D3DXVECTOR3 pos )
{
	SetPosition(iID, pos);
}
...
// WickedX - 271014 r114 - function wrapper for dbCameraNear(int iID)
float dbCameraNear( int iID )
{
	return GetNear(iID);
}

// WickedX - 271014 r114 - function wrapper for dbCameraFar(int iID)
float dbCameraFar( int iID )
{
	return GetFar(iID);
}
...
// WickedX - 271014 r114 - function wrapper for dbCameraFOV(iID)
float dbCameraFOV( int iID )
{
	return GetFOV(iID);
}
...
// WickedX - 261014 r114 - function wrapper for dbCameraAspect(int iID)
float dbCameraAspect ( int iID )
{
	return GetAspect(iID);
}
