...
// WickedX - 240814 r114 - Added function prototype for SetPosition(int iID, D3DXVECTOR3 pos)
DARKSDK void		SetPosition						( int iID, D3DXVECTOR3 rot);
...
DARKSDK DWORD		GetLookZEx 						( int iID );
		...
		// WickedX - 240814 r114 - Added internal function dbSetPosition(int iID, D3DXVECTOR3 pos)
