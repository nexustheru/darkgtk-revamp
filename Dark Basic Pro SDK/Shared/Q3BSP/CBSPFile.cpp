...
void EndRenderStates ( void )
{
	...
	m_pD3D->SetSamplerState ( 0, D3DSAMP_MAGFILTER, 2 );
	m_pD3D->SetSamplerState ( 0, D3DSAMP_MINFILTER, 2 );
	m_pD3D->SetSamplerState ( 0, D3DSAMP_MIPFILTER, 2 );
	m_pD3D->SetTextureStageState ( 0, D3DTSS_TEXCOORDINDEX,		0 );
...
void SetQ3ATextureStageStates ( int mode )
{
	...
	switch ( mode )
	{
		case Q3A_MODE_LIGHTMAP:
		{
			...
			// mike - 240604 - dynamic lighting not to be used with bsp
			// stage 3 - for additional dynamic lighting!
			//m_pD3D->SetTextureStageState ( 2, D3DTSS_COLORARG1, D3DTA_CURRENT     );
			//m_pD3D->SetTextureStageState ( 2, D3DTSS_COLOROP,   D3DTOP_MODULATE   );
			//m_pD3D->SetTextureStageState ( 2, D3DTSS_COLORARG2, D3DTA_DIFFUSE    );
			//m_pD3D->SetTextureStageState ( 2, D3DTSS_ALPHAARG1, D3DTA_CURRENT     );
			//m_pD3D->SetTextureStageState ( 2, D3DTSS_ALPHAOP,   D3DTOP_SELECTARG1 );
			
			// set texture mode
			//m_pD3D->SetSamplerState ( 2, D3DSAMP_ADDRESSU,  D3DTADDRESS_WRAP );
			//m_pD3D->SetSamplerState ( 2, D3DSAMP_ADDRESSV,  D3DTADDRESS_WRAP );

			// filter
			//m_pD3D->SetSamplerState ( 2, D3DSAMP_MINFILTER, D3DTEXF_LINEAR );
			//m_pD3D->SetSamplerState ( 2, D3DSAMP_MAGFILTER, D3DTEXF_LINEAR );
			//m_pD3D->SetSamplerState ( 2, D3DSAMP_MIPFILTER, D3DTEXF_LINEAR );
